    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          variant: "destructive",
          title: "Signup Failed",
          description: errorData.detail || "Could not create your account.",
        });
      }
    } catch (error) {
      toast({
      ...
      <div className="max-w-md mx-auto px-4 pt-20 pb-16">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm">Join 10,000+ Indian investors on MarketMind.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            >
              {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : "Sign Up Free"} <UserPlus className="h-4 w-4" />
            </button>
          </form>
